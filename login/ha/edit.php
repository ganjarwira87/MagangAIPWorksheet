...
<body>
	<div class="container mt-5 ">
		<center class="mb-5" ><h2><img src="https://fontmeme.com/permalink/230112/42cdfe09e0544eb6f58c2b601cec869e.png" alt=""></h2></center>
		<hr>
		<form action="edit_act.php" method="post" enctype="multipart/form-data">
			...
			<div class="mb-3">
				...
				<a href="index.php" class="btn btn-danger"><img src="https://fontmeme.com/permalink/230112/c2eb84a891274325819b0eca268a4a08.png"></a>
			</div>
		</form>
